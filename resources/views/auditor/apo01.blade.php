						...
						<div class="co-12">
							...
							<div class="panel"  >   
								<div class="panel-heading">                                    
									   <a href="#" class="btn btn-warning"><i class="lnr lnr-pencil"></i>  APO01</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO02</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO03</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO04</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO05</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO06</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO07</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO08</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO09</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO010</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO011</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO012</a>
									   <a href="#" class="btn btn-outline-warning"><i class="lnr lnr-pencil"></i>  APO013</a>
								   </div>
